 ...
 */
export declare enum LocalizationErrorType {
...
export declare class LocalizationError extends Error {
    ...
    constructor(type: LocalizationErrorType, message: string, originalValue?: any | undefined);
}
/**
 * Print-related types
 */
...
export type { NumberConverter, DateConverter, DateFormatOptions, PrinterLocalizationSettings, LocalizationConfig, LocalizationService } from '../interfaces/localization';
